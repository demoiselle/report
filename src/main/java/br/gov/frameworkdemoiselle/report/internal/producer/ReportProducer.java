...
public class ReportProducer {
	...
	@Produces
	@Default
	public static Report create(final InjectionPoint ip) {
		Field field = (Field) ip.getMember();
		String path = DEFAULT_PATH+field.getName()+".jasper";
	...
	public static Report create(String path) {
		return new ReportImpl(path);
	}
